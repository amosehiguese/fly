      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
        <form onSubmit={handleSubmit} className="flex items-center">
          ...
          <button
            ...
            // aria-label={tCommon("chat.attachFile")}
          >
            <Paperclip size={20} />
          </button>
          <input
...
export default function SupplierChatPage() {
  ...
  const supplierId = dashboard?.data?.supplier_details?.supplier_id;

  const isPending = isMessagesPending;
  const recipientName =
    conversation?.recipient_name ===
    dashboard?.data?.supplier_details?.company_name
    ...
    <div className="flex flex-col h-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex items-center gap-4 p-4 border-b border-gray-200 dark:border-gray-700">
        <button
          ...
          aria-label={tCommon("chat.goBack")}
        >
