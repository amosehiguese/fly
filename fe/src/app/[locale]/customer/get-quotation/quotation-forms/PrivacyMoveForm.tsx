...
const PrivacyMoveDetailsForm = ({ form, handleNext }: any) => {
  ...
  const services = [
    ...
    { value: "furnitureAssembly", label: t("services.furnitureAssembly") },
    { value: "moveCleaning", label: t("services.moveCleaning") },
  ...
  return (
    <FormWrapper form={form} onSubmit={onSubmit}>
      {formStage === 1 ? (
        ...
        <PrivacyMoveDetailsForm form={form} handleNext={handleNext} />
      ) : formStage === 3 ? (
