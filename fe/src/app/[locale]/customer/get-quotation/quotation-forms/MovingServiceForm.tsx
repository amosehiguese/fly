...
//         render={({ field }) => (
//           <FormItem>
//             <FormLabel>Volume of Items (cubic feet)</FormLabel>
//             <FormControl>
//               <Input
//                 {...field}
//                 placeholder="e.g., 500"
...
//   useFormPersist(form, "movingServiceForm", ["photos"]);

//   const handleSubmit = (data: MovingService) => {
//     // Convert boolean fields to numbers before submission
//     const formattedData = {
//       ...data,
//       needs_packing: data.needs_packing ? 1 : 0,
//       needs_dump_service: data.needs_dump_service ? 1 : 0,
//       heavy_lifting_required: data.heavy_lifting_required ? 1 : 0,
//     };
