...
const EstateClearanceDetailsForm = ({ form, handleNext }: any) => {
  ...
  const services = [
    { id: "recycle", label: t("services.recycle") },
    { id: "packing", label: t("services.packing") },
    { id: "unpacking", label: t("services.unpacking") },
    { id: "furnitureAssembly", label: t("services.furnitureAssembly") },
...
export const EstateClearanceForm: React.FC<EstateClearanceFormProps> = ({
  ...
  // useFormPersist(form, "estateClearanceForm", ["photos"]);
