...
import {
  useDisputeChatsByDisputeId,
  useSendDisputeMessage,
} from "@/hooks/customer/useDisputeChats";
...
const Page = () => {
  ...
  const { data } = useDisputeChatsByDisputeId(id);
  const messages = data?.data;

  const { mutate: sendMessage } = useSendDisputeMessage(id);
      ...
      <MainContainer>
        <ChatContainer>
          <ConversationHeader style={{ backgroundColor: "#fff" }}>
            ...
            <ConversationHeader.Content info="Online" userName={"Supplier"}>
              ...
              acc.push(
                msg.image_url ? (
                  ...
                  <div key={index} className="flex flex-col">
                    ...
                    >
                      <Avatar
                        name={msg.sender_type === "customer" ? "You" : "Admin"}
                        size="sm"
                        src={
                          msg.sender_type === "customer"
                            ? `https://avatar.iran.liara.run/username?username=${"M"}+${"E"}&background=fde7e7&color=ec1b25`
