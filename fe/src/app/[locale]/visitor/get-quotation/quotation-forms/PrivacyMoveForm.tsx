...
import { PrivacyMove, createPrivacyMoveSchema } from "../i18n-schema";
...
interface PrivacyMoveFormProps {
...
const PrivacyDetailsForm = ({
  ...
  const services = [
    ...
    { id: 6, value: "driveToDump", label: t("services.driveToDump") },
  ];

  const handleClick = async () => {
    // Only validate fields relevant to this form stage
...
export const PrivacyMoveForm: React.FC<PrivacyMoveFormProps> = ({
  onSubmit,
  mutation,
  formStage,
  handleNext,
  ...
  const form = useForm<PrivacyMove>({
    resolver: zodResolver(createPrivacyMoveSchema(t)),
    defaultValues: {
      name: "",
      from_city: "",
      to_city: "",
      ...
      email: "",
      phone: "",
      type_of_service: "Private Move",
      pickup_address: "",
      delivery_address: "",
      service_type: "Private Move",
      latest_date: "",
      move_type: "apartment",
      from_rok: undefined,
      to_rok: undefined,
  ...
  return (
    <FormWrapper form={form} onSubmit={onSubmit}>
      {formStage === 1 ? (
        ...
        <PrivacyDetailsForm form={form} handleNext={handleNext} />
      ) : formStage === 3 ? (
