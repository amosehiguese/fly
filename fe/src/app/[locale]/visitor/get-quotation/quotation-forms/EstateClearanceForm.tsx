...
// components/quotation-forms/EstateClearanceForm.tsx
...
import { EstateClearance, createEstateClearanceSchema } from "../i18n-schema";

// const services = [
//   {
//     id: 6,
//     value: "sortDriveToDump",
//     label: t("services.sortDriveToDump"),
//   },
//   {
//     id: 7,
//     value: "justDriveToDump",
//     label: t("services.justDriveToDump"),
//   },
//   {
//     id: 8,
//     value: "moveOutCleaning",
//     label: t("services.moveOutCleaning"),
//   },
//   {
//     id: 9,
//     value: "sanitationCleaning",
//     label: t("services.sanitationCleaning"),
//   },
//   {
//     id: 10,
//     value: "moveThingsHome",
//     label: t("services.moveThingsHome"),
//   },
// ];
interface EstateClearanceFormProps {
  onSubmit: (data: EstateClearance) => void;
  mutation: UseMutationResult<unknown, unknown, unknown>;
  formStage: number;
  handleNext: () => void;
}

const EstateClearanceDetailsForm = ({ form, handleNext }: any) => {
  const t = useTranslations("quotation.estateClearance");
  ...
  const services = [
    { id: 1, value: "recycle", label: t("services.recycle") },
    { id: 2, value: "packing", label: t("services.packing") },
    { id: 3, value: "unpacking", label: t("services.unpacking") },
    {
      id: 4,
      value: "furnitureAssembly",
      label: t("services.furnitureAssembly"),
    },
    { id: 5, value: "moveCleaning", label: t("services.moveCleaning") },
    { id: 6, value: "transport", label: t("services.transport") },
  ];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("describeFloor")}</FormLabel>
...
export const EstateClearanceForm: React.FC<EstateClearanceFormProps> = ({
  onSubmit,
  mutation,
  formStage,
  handleNext,
  ...
  const form = useForm<EstateClearance>({
    resolver: zodResolver(createEstateClearanceSchema(t)),
    defaultValues: {
      name: "",
      from_city: "",
      to_city: "",
      ...
      email: "",
      phone: "",
      type_of_service: "Estate Clearance",
      pickup_address: "",
      delivery_address: "",
      service_type: "Estate Clearance",
      latest_date: "",
      move_type: "apartment",
      from_rok: 0,
      to_rok: 0,
  ...
  return (
    <FormWrapper form={form} onSubmit={onSubmit}>
      {formStage === 1 ? (
        ...
        <EstateClearanceDetailsForm form={form} handleNext={handleNext} />
      ) : formStage === 3 ? (
