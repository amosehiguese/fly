...
const GetQuote = ({ className = "" }: { className?: string }) => {
  ...
  const quotationTypes = [
    ...
    // { value: "secrecy-move", label: "Secrecy Move" },
  ...
  return (
    <div
      className={cn(
        "relative bg-[url(/01.jpg)] min-h-screen bg-cover bg-center bg-no-repeat flex justify-center w-full z-0",
        className
      )}
      id="get-quote"
    >
      <div className="bg-black/[0.5] w-full flex justify-center items-center">
        <div className=" max-w-[1280px] ">
          <div className="  w-full px-6 md:px-8 py-24">
            <div className="w-full justify-center items-center flex flex-col md:space-x-24 md:flex-row ">
              <div className="md:w-1/2 flex flex-col justify-center p-0 mb-6 md:mb-0 md:p-6 text-white">
                <h1 className="font-livvic text-2xl md:text-3xl font-bold mb-4 text-shadow">
                  {t2("title")}
                </h1>
              ...
              <div className="bg-white md:w-1/2 px-4 md:px-8 py-6 rounded-[10px] shadow-sm">
                  ...
                  >
                    ...
                    <FormField
                      ...
                      render={({ field: { onChange, value, ...field } }) => (
                        <FormItem>
                          <FormLabel>{t("form.pickupAddress")}</FormLabel>
                          <FormControl>
                            <div className="relative">
                              ...
                              <GooglePlacesAutocomplete
                                ...
                                selectProps={{
                                  ...
                                  placeholder: t("form.enterPickupLocation"),
                                  name: field.name,
                                  onBlur: field.onBlur,
              ...
              {/* <div className="md:w-[50%] flex justify-end items-center rounded-[16px]">
            <AnimatedImage
              src="/get-quote.png"
              width={1000}
              height={1000}
              className="w-[200px] h-[200px]  md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] object-contain"
              alt="homepage image"
            />
          </div> */}
            </div>
