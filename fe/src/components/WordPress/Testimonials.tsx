...
const TestimonialSection = () => {
  ...
  return (
    <motion.div
      ...
      className="relative py-10 lg:py-20 md:w-full w-[90vw] max-w-[1400px] "
    >
      <Carousel
        opts={{
          align: "start",
      ...
      >
        <CarouselContent className="-ml-2 md:-ml-6">
          {t.raw("items").map((testimonial: Testimonial, index: number) => (
            <CarouselItem
              key={index.toString()}
              className="pl-2 lg:pl-6 basis-full sm:basis-1/2 md:basis-1/3 pb-14"
            >
              <div className="bg-[#FFF1F2] shadow-lg relative rounded-xl p-4 md:p-8 h-full flex flex-col overflow-visible">
                <div className="flex items-center justify-center">
                  <Quote className="text-primary w-8 h-8 md:w-12 md:h-12 mb-4 md:mb-6" />
                </div>
                <div className="flex-grow mb-6">
                  <p className="text-[#666666] text-base md:text-lg text-center leading-relaxed">
                    {testimonial.text}
                  </p>
                </div>
                ...
                <div className="absolute -bottom-16 left-0 right-0 z-10">
                  <div className="flex flex-col items-center">
                    ...
                    <h4 className="mt-2 font-semibold text-base md:text-lg text-black  px-4 py-1 rounded-full shadow-sm">
                      {testimonial.author}
                    </h4>
                  </div>
                </div>
